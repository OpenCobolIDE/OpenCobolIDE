...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.plainTextEditDesc)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.radioButtonBug.setText(_translate("Dialog", "Repor&t a bug"))
        self.radioButtonWish.setText(_translate("Dialog", "Su&ggest an enhancement"))

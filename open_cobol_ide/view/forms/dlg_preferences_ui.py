...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 639, 568))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 639, 568))
        ...
        self.scrollAreaWidgetContents_7.setGeometry(QtCore.QRect(0, 0, 639, 568))
        ...
        self.comboBoxStandard.addItem("")
        self.comboBoxStandard.addItem("")
        self.formLayout_6.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.comboBoxStandard)
        ...
        self.formLayout_6.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.checkBoxFreeFormat)
        ...
        self.formLayout_6.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.le_compiler_flags)
        self.label_17 = QtWidgets.QLabel(self.scrollAreaWidgetContents_7)
        self.label_17.setObjectName("label_17")
        self.formLayout_6.setWidget(10, QtWidgets.QFormLayout.LabelRole, self.label_17)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/ide-icons/rc/list-add.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolButtonAddLibPath.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/ide-icons/rc/list-remove.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolButtonRemoveLibPath.setIcon(icon3)
        ...
        self.formLayout_6.setLayout(10, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_10)
        self.label_18 = QtWidgets.QLabel(self.scrollAreaWidgetContents_7)
        self.label_18.setObjectName("label_18")
        self.formLayout_6.setWidget(11, QtWidgets.QFormLayout.LabelRole, self.label_18)
        self.lineEditLibs = QtWidgets.QLineEdit(self.scrollAreaWidgetContents_7)
        self.lineEditLibs.setObjectName("lineEditLibs")
        self.formLayout_6.setWidget(11, QtWidgets.QFormLayout.FieldRole, self.lineEditLibs)
        ...
        self.formLayout_6.setWidget(12, QtWidgets.QFormLayout.LabelRole, self.label_compiler_path)
        ...
        self.toolButtonCheckCompiler = QtWidgets.QToolButton(self.scrollAreaWidgetContents_7)
        ...
        self.formLayout_6.setWidget(14, QtWidgets.QFormLayout.LabelRole, self.labelVCVARS)
        ...
        self.formLayout_6.setLayout(14, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_8)
        ...
        self.formLayout_6.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.lineEditCobcExts)
        self.label_35 = QtWidgets.QLabel(self.scrollAreaWidgetContents_7)
        self.label_35.setObjectName("label_35")
        self.formLayout_6.setWidget(9, QtWidgets.QFormLayout.LabelRole, self.label_35)
        ...
        self.formLayout_6.setLayout(4, QtWidgets.QFormLayout.FieldRole, self.gridLayout_5)
        ...
        self.lineEditOutputDirectory = QtWidgets.QLineEdit(self.scrollAreaWidgetContents_7)
        self.lineEditOutputDirectory.setObjectName("lineEditOutputDirectory")
        self.formLayout_6.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.lineEditOutputDirectory)
        ...
        self.label_37 = QtWidgets.QLabel(self.groupBoxEnvVars)
        self.label_37.setObjectName("label_37")
        self.formLayout_12.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.label_37)
        self.PATH = QtWidgets.QLineEdit(self.groupBoxEnvVars)
        self.PATH.setObjectName("PATH")
        self.formLayout_12.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.PATH)
        self.label_38 = QtWidgets.QLabel(self.groupBoxEnvVars)
        self.label_38.setObjectName("label_38")
        self.formLayout_12.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.label_38)
        self.COB_CONFIG_DIR = QtWidgets.QLineEdit(self.groupBoxEnvVars)
        ...
        self.label_39 = QtWidgets.QLabel(self.groupBoxEnvVars)
        self.label_39.setObjectName("label_39")
        self.formLayout_12.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.label_39)
        self.COB_COPY_DIR = QtWidgets.QLineEdit(self.groupBoxEnvVars)
        ...
        self.label_41 = QtWidgets.QLabel(self.groupBoxEnvVars)
        self.label_41.setObjectName("label_41")
        self.formLayout_12.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.label_41)
        self.COB_INCLUDE_PATH = QtWidgets.QLineEdit(self.groupBoxEnvVars)
        ...
        self.label_42 = QtWidgets.QLabel(self.groupBoxEnvVars)
        self.label_42.setObjectName("label_42")
        self.formLayout_12.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.label_42)
        self.COB_LIB_PATH = QtWidgets.QLineEdit(self.groupBoxEnvVars)
        ...
        self.formLayout_6.setWidget(13, QtWidgets.QFormLayout.FieldRole, self.groupBoxEnvVars)
        ...
        self.scrollAreaWidgetContents_6.setGeometry(QtCore.QRect(0, 0, 639, 568))
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QtCore.QRect(0, 0, 639, 549))
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/ide-icons/rc/database.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.tabSqlCobol, icon4, "")
...
"as possible to get back to the previous indentation level."))
        ...
        self.label_37.setText(_translate("Dialog", "PATH:"))
        self.label_38.setText(_translate("Dialog", "COB_CONFIG_DIR:"))
        self.label_39.setText(_translate("Dialog", "COB_COPY_DIR:"))
        self.label_41.setText(_translate("Dialog", "COB_INCLUDE_PATH:"))
        self.label_42.setText(_translate("Dialog", "COB_LIB_PATH:"))

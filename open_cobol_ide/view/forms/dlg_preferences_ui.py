...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 310, 514))
        ...
        self.scrollAreaWidgetContents_7.setGeometry(QtCore.QRect(0, 0, 372, 657))
        ...
        self.scrollAreaWidgetContents_6.setGeometry(QtCore.QRect(0, 0, 956, 636))
        ...
        self.formLayout_13.setContentsMargins(-1, 0, -1, -1)
        ...
        self.formLayout_13.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.checkBoxRunExtTerm)
        self.lbl_external_terminal_command = QtWidgets.QLabel(self.scrollAreaWidgetContents_6)
        self.lbl_external_terminal_command.setObjectName("lbl_external_terminal_command")
        self.formLayout_13.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.lbl_external_terminal_command)
        ...
        self.formLayout_13.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.lineEditRunTerm)
        self.verticalLayout_13.addLayout(self.formLayout_13)
...
"as possible to get back to the previous indentation level."))
        ...
        self.checkBoxRunExtTerm.setText(_translate("Dialog", "Run in e&xternal terminal:"))
        self.lbl_external_terminal_command.setText(_translate("Dialog", "Command:"))

...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 368, 626))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 364, 355))
        ...
        self.scrollAreaWidgetContents_7.setGeometry(QtCore.QRect(0, 0, 616, 841))
        ...
        self.formLayout_6.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.lineEditOutputDirectory)
        ...
        self.formLayout_6.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.lineEditCobcExts)
        self.label_8 = QtWidgets.QLabel(self.scrollAreaWidgetContents_7)
        self.label_8.setObjectName("label_8")
        self.formLayout_6.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.label_8)
        ...
        self.comboBoxStandard.addItem("")
        self.comboBoxStandard.addItem("")
        self.formLayout_6.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.comboBoxStandard)
        self.label_9 = QtWidgets.QLabel(self.scrollAreaWidgetContents_7)
        self.label_9.setObjectName("label_9")
        self.formLayout_6.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.label_9)
        ...
        self.formLayout_6.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.checkBoxFreeFormat)
        self.label_15 = QtWidgets.QLabel(self.scrollAreaWidgetContents_7)
        self.label_15.setObjectName("label_15")
        self.formLayout_6.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.label_15)
        ...
        self.formLayout_6.setLayout(7, QtWidgets.QFormLayout.FieldRole, self.gridLayout_5)
        ...
        self.formLayout_6.setWidget(12, QtWidgets.QFormLayout.FieldRole, self.le_compiler_flags)
        ...
        self.formLayout_6.setWidget(8, QtWidgets.QFormLayout.LabelRole, self.label_37)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/ide-icons/rc/document-open.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/ide-icons/rc/list-add.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolButtonAddRelativeLibPath.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/ide-icons/rc/list-remove.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolButtonRemoveLibPath.setIcon(icon4)
        ...
        self.formLayout_6.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.labelVCVARS)
        ...
        self.formLayout_6.setLayout(2, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_8)
        ...
        self.btAddAbsoluteCopyPath.setIcon(icon2)
        ...
        self.btAddRelativeCopyPath.setIcon(icon3)
        ...
        self.btRemoveCopyPath.setIcon(icon4)
        ...
        self.formLayout_6.setLayout(8, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_12)
        ...
        self.scrollAreaWidgetContents_6.setGeometry(QtCore.QRect(0, 0, 192, 69))
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QtCore.QRect(0, 0, 333, 543))
        ...
        self.formLayout_9.setItem(6, QtWidgets.QFormLayout.LabelRole, spacerItem5)

...
#
# Created: Fri Apr  4 17:46:46 2014
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lwMenu.setMaximumSize(QtCore.QSize(78, 16777215))
        ...
        item.setIcon(icon2)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/ide-icons/rc/Preferences-system.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item = QtGui.QListWidgetItem(self.lwMenu)
        item.setIcon(icon3)
        ...
        self.homeWidget.setProperty("icon", icon4)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lwMenu.item(2).setText(QtGui.QApplication.translate("Dialog", "Build & Run", None, QtGui.QApplication.UnicodeUTF8))
...
"", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.labelShellCmd.setText(QtGui.QApplication.translate("Dialog", "External terminal:", None, QtGui.QApplication.UnicodeUTF8))
        self.label_6.setText(QtGui.QApplication.translate("Dialog", "Run program in external terminal:", None, QtGui.QApplication.UnicodeUTF8))
